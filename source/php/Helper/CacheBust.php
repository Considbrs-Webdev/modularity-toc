...
namespace ModularityToc\Helper;
...
class CacheBust
{
    ...
    {
        $jsonPath = MODULARITY_TOC_PATH . apply_filters(
            'ModularityToc/Helper/CacheBust/RevManifestPath',
        ...
        if (file_exists($jsonPath)) {
            ...
            echo '<div style="color:red">Error: Assets not built. Go to ' . MODULARITY_TOC_PATH . ' and run gulp. See ' . MODULARITY_TOC_PATH . 'README.md for more info.</div>';
        }
    }
}
